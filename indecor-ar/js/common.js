...
$(document).ready(function() {
	...
	page_title.appendTo(breadcrumbs_container_inner);
	category_image.prependTo(breadcrumbs_container);
	
	// move title occountdown_module 
	$('.countdown-style1 .module-title').prependTo('.countdown-style1 .list-style .item .item-inner .caption');
	$('.countdown-style2 .box-timer').appendTo('.countdown-style2 .module-description');
